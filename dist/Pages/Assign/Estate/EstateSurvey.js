...
exports.EstateSurvey = void 0;
var react_1 = require("react");
var styled_components_1 = require("styled-components");
var react_2 = require("react");
var EstateSurveyList_1 = require("../../../Assets/Survey/EstateSurveyList");
...
var AlertModal_1 = require("../../../Global/AlertModal");
var EstateSurvey = function () {
        ...
        if (direction === "next" && surveyType === "land" && process === 6) {
            ...
            if (direction === "next" && checkClick) {
                ...
                setResponses(function (prev) {
                    return prev.concat({
                        question: EstateSurveyList_1.Estate_SurveyList[process].question,
                        response: EstateSurveyList_1.Estate_SurveyList[process].responses[clicked].main,
                    });
                });
    ...
    return (<Layout_1.Layout>
      <Wrap>
        <SurveyHeader_1.SurveyHeader title={"종합부동산세 환급받기"} undoPage={"/survey/verify/transfer"}/>
        <SurveyContentBox>
          <QuestionBox>{EstateSurveyList_1.Estate_SurveyList[process].question}</QuestionBox>
          <ResponseBox>
            {EstateSurveyList_1.Estate_SurveyList[process].responses.map(function (response, index) {
...
exports.EstateSurvey = EstateSurvey;
